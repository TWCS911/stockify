                        ...
                        <div class="card-body">
                            <form action="{{ route('barang-keluar.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('jumlah_keluar') is-invalid @enderror" id="jumlah_keluar" name="jumlah_keluar" value="{{ old('jumlah_keluar') }}" min="1" required>
                                    @error('jumlah_keluar')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <!-- Admin (Penjual) -->
                                <div class="form-group">
                                    <label for="penjual">Admin yang Melayani Pembeli</label>
                                    <select class="form-control @error('penjual') is-invalid @enderror" id="penjual" name="penjual" required>
                                        <option value="">-- Pilih Admin --</option>
                                        <option value="2" {{ old('penjual') == '2' ? 'selected' : '' }}>Admin 2</option>
                                        <option value="3" {{ old('penjual') == '3' ? 'selected' : '' }}>Admin 3</option>
                                        <option value="4" {{ old('penjual') == '4' ? 'selected' : '' }}>Admin 4</option>
                                        <option value="5" {{ old('penjual') == '5' ? 'selected' : '' }}>Admin 5</option>
                                        <option value="6" {{ old('penjual') == '6' ? 'selected' : '' }}>Admin 6</option>
                                    </select>
                                    @error('penjual')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input 
                                        ...
                                        minlength="3" 
                                        pattern="[A-Za-z\s]+" 
                                        title="Pembeli hanya boleh terdiri dari huruf dan minimal 3 karakter"
                                        aria-describedby="pembeliHelp">
                                    @error('pembeli')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('no_telp') is-invalid @enderror" id="no_telp" name="no_telp" value="{{ old('no_telp') }}" required 
                                           minlength="10" pattern="^[0-9]{10,}$" title="Nomor telepon hanya boleh mengandung angka dan minimal 10 digit">
                                    @error('no_telp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('tujuan') is-invalid @enderror" id="tujuan" name="tujuan" value="{{ old('tujuan') }}" required
                                           minlength="5" pattern="^[A-Za-z0-9\s\.,/-]+$" title="Alamat tujuan harus mengandung huruf dan bisa mengandung angka, koma, titik, atau garis miring.">
                                    @error('tujuan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
